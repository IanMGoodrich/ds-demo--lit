...
.img-swatch--ctas-wrapper {
  display: flex;
  justify-content: space-evenly;
  row-gap: 1rem;
}

.img-swatch--buttons-wrapper,
...
:host([theme='default']) {
  --bg-color: var(--cl-background-primary-default);
...
:host([theme='sprawl']) {
  --bg-color: var(--cl-background-primary-sprawl);
...
:host([theme='floral']) {
  --bg-color: var(--cl-background-primary-floral);
